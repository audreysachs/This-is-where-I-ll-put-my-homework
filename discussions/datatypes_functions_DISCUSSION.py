...
def g():
    print("beep beep")
    return True #Function that outputs a Boolean

variable4 = g # Data type of variable4: None

variable5 = g() # Data type of variable5: Function

variable6 = [1,2,3] #List

variable7 = (1,3,5) #Tuple

variable8 = {"brand": "Ford", "model": "Mustang", "year": 1964} #Dictionary4
...
# normal division is just normal division with decimals
# floor division gives the division without remainder
# modulo division gives only the remainder
...
def two_of_three(a, b, c):
    ...
    minimum_number = min(a,b,c) #cant do min of sum of squares bc just one number
    minimum_squared = minimum_number**2
    return sum_of_squares-minimum_squared
two_of_three(1,2,3)
